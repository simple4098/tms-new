...
Ext.define('FQServiceApp.controller.Navigation', {
    extend: 'Ext.app.Controller',
    stores:[
        "TaskEntityStore","JobTypeStore"
    ],
    refs: [
        {
            ref: 'contentPanel',
    ...
    init: function(application) {
         Ext.Ajax.on(
             {
                 requestexception: function(a,response){
                    var _response = Ext.JSON.decode(response.responseText);
                    Ext.MessageBox.alert('系统提示',_response.msg);
                 },
                 beforerequest:function(connection,options){
                     if(typeof Ext.ENV!='undefined' && typeof Ext.ENV.contextPath!='undefined'){
                         if(!/^http:\/\/*/.test(options.url))
                         options.url=Ext.ENV.contextPath+options.url;
                     }
